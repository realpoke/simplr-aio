...
public enum FishType {
    ...
    public static final Set<String> COOKED_FISH_NAMES = Stream.of(FishType.values()).map(fish -> fish.name).collect(Collectors.toSet());
    public static final Set<String> RAW_FISH_NAMES = Stream.of(FishType.values()).map(FishType::getRawFishName).collect(Collectors.toSet());
    ...
    FishType(final String name, final FishingMethod fishingMethod, final int lvlRequirement, final FishingLocation... locations) {
        this.name = name;
