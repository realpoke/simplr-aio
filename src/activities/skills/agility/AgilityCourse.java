...
public enum AgilityCourse {
    ...
    GNOME_STRONGHOLD("Gnome Stronghold Agility Course",
            new CoursePart(ObstacleType.LOG_BALANCE, new Area(2471, 3435, 2477, 3438)),
            new CoursePart(ObstacleType.OBSTACLE_NET, new Area(2469, 3425, 2479, 3429)),
            new CoursePart(ObstacleType.TREE_BRANCH_UP, new Area(new Position(2476, 3424, 1), new Position(2471, 3422, 1))),
            new CoursePart(ObstacleType.BALANCING_ROPE, new Area(new Position(2477, 3421, 2), new Position(2472, 3418, 2))),
            new CoursePart(ObstacleType.TREE_BRANCH_DOWN, new Area(new Position(2488, 3421, 2), new Position(2483, 3418, 2))),
            new CoursePart(ObstacleType.OBSTACLE_NET, new Area(2481, 3417, 2490, 3426)),
            new CoursePart(ObstacleType.OBSTACLE_PIPE, new Area(2490, 3427, 2481, 3431))
    ),
    ...
    FALADOR_ROOFTOP("Falador Rooftop",
            ...
            new CoursePart(
                    ObstacleType.JUMP_EDGE,
                    new Area(new Position(3019, 3335, 3), new Position(3024, 3332, 3))
            )
    ),
    SEERS_VILLAGE_ROOFTOP("Seers Village Rooftop",
            new CoursePart(ObstacleType.CLIMB_WALL, new Area(2728, 3487, 2730, 3489)),
            new CoursePart(ObstacleType.GAP, new Area(new Position(2730, 3490, 3), new Position(2721, 3497, 3)), new Position[]{new Position(2724, 3492, 3)}),
            new CoursePart(ObstacleType.TIGHTROPE, new Area(new Position(2714, 3498, 2), new Position(2704, 3487, 2))),
            new CoursePart(ObstacleType.GAP, new Area(new Position(2716, 3482, 2), new Position(2709, 3476, 2))),
            new CoursePart(ObstacleType.GAP, new Area(new Position(2716, 3475, 3), new Position(2699, 3470, 3)), new Position[]{new Position(2705, 3472, 3)}),
            new CoursePart(ObstacleType.JUMP_EDGE, new Area(new Position(2697, 3466, 2), new Position(2703, 3459, 2)))
    ),
    POLLNIVNEACH_ROOFTOP("Pollnivneach Rooftop",
            new CoursePart(ObstacleType.BASKET, new Area(3350, 2961, 3352, 2962)),
            new CoursePart(ObstacleType.MARKET_STALL, new Area(new Position(3351, 2968, 1), new Position(3346, 2963, 1)), new Position[]{new Position(3351, 2968, 1)}),
            new CoursePart(ObstacleType.BANNER, new Area(new Position(3352, 2976, 1), new Position(3355, 2973, 1)), new Position[]{new Position(3355, 2976, 1)}),
            new CoursePart(ObstacleType.LEAP_GAP, new Area(new Position(3360, 2979, 1), new Position(3362, 2977, 1))),
            new CoursePart(ObstacleType.TREE, new Area(new Position(3366, 2976, 1), new Position(3370, 2974, 1))),
            new CoursePart(ObstacleType.ROUGH_WALL, new Area(new Position(3365, 2982, 1), new Position(3369, 2986, 1))),
            new CoursePart(ObstacleType.MONKEY_BARS, new Area(new Position(3355, 2980, 2), new Position(3365, 2985, 2)), new Position[]{new Position(3361, 2984, 2)}),
            new CoursePart(ObstacleType.JUMP_ON_TREE, new Area(new Position(3357, 2991, 2), new Position(3370, 2995, 2)), new Position[]{new Position(3360, 2995, 2)}),
            new CoursePart(ObstacleType.DRYING_LINE, new Area(new Position(3356, 3004, 2), new Position(3362, 3000, 2)))
    ),
    RELLEKA_ROOFTOP("Relleka Rooftop",
            new CoursePart(ObstacleType.ROUGH_WALL, new Area(2623, 3677, 2627, 3679)),
            new CoursePart(ObstacleType.LEAP_GAP, new Area(2620, 3669, 2628, 3677).setPlane(3)),
            new CoursePart(ObstacleType.TIGHTROPE, new Area(2623, 3656, 2615, 3668).setPlane(3)),
            new CoursePart(ObstacleType.LEAP_GAP, new Area(2632, 3657, 2625, 3651).setPlane(3)),
            new CoursePart(ObstacleType.HURDLE_GAP, new Area(2646, 3655, 2638, 3649).setPlane(3)),
            new CoursePart(ObstacleType.TIGHTROPE, new Area(2652, 3665, 2642, 3656).setPlane(3)),
            new CoursePart(ObstacleType.PILE_OF_FISH, new Area(2669, 3687, 2652, 3665).setPlane(3))
    ),

    ARDOUGNE("Ardougne Rooftop",
            new CoursePart(ObstacleType.WOODEN_BEAMS, new Area(2672, 3298, 2676, 3295)),
            new CoursePart(ObstacleType.GAP, new Area(2670, 3303, 2672, 3299).setPlane(3)),
            new CoursePart(ObstacleType.PLANK, new Area(2661, 3319, 2666, 3317).setPlane(3)),
            new CoursePart(ObstacleType.GAP, new Area(2655, 3318, 2657, 3318).setPlane(3)),
            new CoursePart(ObstacleType.GAP, new Area(2652, 3314, 2654, 3312).setPlane(3), new Position(2653, 3308, 3)),
            new CoursePart(ObstacleType.STEEP_ROOF, new Area(2650, 3309, 2653, 3304).setPlane(3)),
            new CoursePart(ObstacleType.GAP, new Area(2655, 3298, 2657, 3296).setPlane(3), true)
            );
