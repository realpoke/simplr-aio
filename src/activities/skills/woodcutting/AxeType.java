...
public enum AxeType implements Tool {
    ...
    AxeType(final String name, final int wcLevelRequired, final int attLevelRequired) {
        this.name = name;
        this.wcLevelRequired = wcLevelRequired;
        this.attLevelRequired = attLevelRequired;
    }

    AxeType(final String name, final int wcLevelRequired, final int attLevelRequired, final boolean membersOnly) {
