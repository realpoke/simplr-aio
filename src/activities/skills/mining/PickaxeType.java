...
public enum PickaxeType implements Tool {
    ...
    PickaxeType(final String name, final int miningLevelRequired, final int attackLevelRequired) {
        this.name = name;
        this.miningLevelRequired = miningLevelRequired;
        this.attackLevelRequired = attackLevelRequired;
    }

    PickaxeType(final String name, final int miningLevelRequired, final int attackLevelRequired, final boolean membersOnly) {
        this(name, miningLevelRequired, attackLevelRequired);
        this.membersOnly = membersOnly;
    }

    public static List<String> getNames() {
        return Arrays.stream(values()).map(PickaxeType::toString).collect(Collectors.toList());
    }
