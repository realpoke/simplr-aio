...
public class Paint extends CustomMethodProvider {
     ...
     * @param position
     *            - Position object
     * @see {@link Paint#drawString(Graphics2D, String, Rectangle)}
     */
     ...
     * @see {@link Paint#drawClickBounds(Graphics2D, Entity)}
     * @see {@link Paint#drawCube(Graphics2D, Entity)}
     * @see {@link Paint#drawMinimapPoint(Graphics2D, Vector3D)}
     * @see {@link Paint#drawTile(Graphics2D, Entity)}
     * @see {@link Paint#drawBox(Graphics2D, Entity)}
     * @see {@link Paint#drawWireframe(Graphics2D, Entity)}
     * @see {@link Paint#drawString(Graphics2D, String, Position)}
     * @see {@link Paint#drawString(Graphics2D, String, Entity)}
     */
     ...
     * @param entity
     *            - Entity object
     * @see {@link Paint#drawShape(Graphics2D, Shape)}
     */
    private void drawWireframe(Graphics2D g, Entity entity) {

        ArrayList<Polygon> polygons = getDisplay().getModelMeshTriangles(entity.getGridX(), entity.getGridY(),
     ...
     * @param entity
     *            - entity object
     * @see {@link Paint#drawTile(Graphics2D, Position)}
     */
     ...
     * @param point
     *            - Point object
     * @see {@link Paint#drawString(Graphics2D, String, int, int)}
     */
